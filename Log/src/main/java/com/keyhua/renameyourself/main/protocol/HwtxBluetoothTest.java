...
//				}
    ...
    public static void main(String[] args) {
        String start_time = TimeUtil.getDatetimeLog("yyyy-MM-dd HH:mm:ss");
        String start_time1 = TimeUtil.getDatetimeLog("HH:mm:ss");
        String start_time2 = TimeUtil.getDatetimeLog("yyyyMMdd-HHmmss");
