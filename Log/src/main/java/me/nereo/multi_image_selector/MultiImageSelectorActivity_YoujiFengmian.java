...
import com.keyhua.clippicture.ClipPictureActivity;
...
public class MultiImageSelectorActivity_YoujiFengmian extends FragmentActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn_back).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				App.getInstance().setSelectPathYouJiFenmian(null);
				finish();
			}
		});
		...
		mSubmitButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if (resultList != null && resultList.size() > 0) {
					App.getInstance().setSelectPathYouJiFenmian(resultList.get(0));
					finish();
				}
			}
		});
	...
	public void onSingleImageSelected(String path) {
		App.getInstance().setSelectPathYouJiFenmian(path);
		 Intent intent = new Intent();
		 intent.setClass(MultiImageSelectorActivity_YoujiFengmian.this,
	...
	public void onCameraShot(File imageFile) {
		if (imageFile != null) {
			...
			App.getInstance().setSelectPathYouJiFenmian(imageFile.getAbsolutePath());
