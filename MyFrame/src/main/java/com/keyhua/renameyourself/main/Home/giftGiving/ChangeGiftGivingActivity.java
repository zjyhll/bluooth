...
public class ChangeGiftGivingActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_gift_giving);
        initHeaderOther(bacStr, "修改送礼单", true, false, false);
        init();
    }
