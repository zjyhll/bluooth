package com.keyhua.renameyourself.view;
...
public class PullToRefreshView extends LinearLayout {
	...
	private void init() {
		...
		mReverseFlipAnimation.setFillAfter(true);// 会停留在动画结束的状态
	...
	private void addHeaderView() {
		...
		mHeaderUpdateTextView.setText(App.getInstance().getRefreshHomeFrg());
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.mipmap.xlistview_arrow);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.mipmap.xlistview_arrow);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
	...
	public void setLastUpdated(CharSequence lastUpdated) {
		...
		if (lastUpdated != null) {
			App.getInstance().setRefreshHomeFrg(lastUpdated.toString());
			mHeaderUpdateTextView.setVisibility(View.VISIBLE);
